...
{
    class MyPendingEventListAdapter : BaseAdapter<Person>
    {
        private List<Person> mItems;
        private Context mContext;

        public MyPendingEventListAdapter(Context context, List<Person> items)
        {
            mItems = items;
            mContext = context;
        }
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (row == null)
            {
                row = LayoutInflater.From(mContext).Inflate(Resource.Layout.PendingEventRow, null, false);
            }
